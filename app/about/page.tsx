  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-6 px-6 text-center">
        <h1 className="text-4xl font-medium tracking-tight">About Workspace</h1>
        <p className="max-w-md text-muted-foreground">
          We believe productivity tools should be calm and focused. No clutter, no distractions—just the essentials.
        </p>
      </main>
